  ...
  const items = [
    {
      ...
      children: (
        <DualEditor
          leftLanguage="text"
          rightLanguage="text"
          buttonAction={enc(SvcEncode.Base64Encode)}
          reverseButtonAction={dec(SvcEncode.Base64Decode)}
          rightReadOnly={false}
        />
      ),
    },
    {
      ...
      children: (
        <DualEditor
          leftLanguage="html"
          rightLanguage="html"
          buttonAction={enc(SvcEncode.HTMLEncode)}
          reverseButtonAction={dec(SvcEncode.HTMLDecode)}
          rightReadOnly={false}
        />
      ),
    },
    {
      ...
      children: (
        <DualEditor
          leftLanguage="text"
          rightLanguage="text"
          buttonAction={enc(SvcEncode.URLEncode)}
          reverseButtonAction={dec(SvcEncode.URLDecode)}
          rightReadOnly={false}
        />
      ),
    },
